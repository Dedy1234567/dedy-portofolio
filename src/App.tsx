  ...
  <style>{`
    ...
    * { cursor: none !important; }
    ...
    .nav-link {
      ...
      background: none; border: none; transition: color 0.25s; padding: 4px 0;
    }
    .nav-link::after {
    ...
    /* ══════════════════════════════════
       ...
       ≥ 640px: image left, content right
    ══════════════════════════════════ */
    .proj-hcard {
      background: var(--surface); border: 1px solid var(--border);
    ...
    .proj-hcard-img {
      ...
      height: 190px;   /* fixed height on mobile */
    }
    .proj-hcard-img img {
    ...
    .proj-hcard-img::after {
      content: ''; position: absolute; inset: 0; pointer-events: none;
      background: linear-gradient(to top, rgba(6,6,8,0.5) 0%, transparent 60%);
    }
    ...
    @media (min-width: 640px) {
      ...
      .proj-hcard-img::after {
        background:
          linear-gradient(to right, transparent 55%, rgba(13,13,18,0.8) 100%),
          linear-gradient(to top, rgba(6,6,8,0.4) 0%, transparent 55%);
      }
    }
    ...
    @media (min-width: 768px) {
      .resume-grid { grid-template-columns: 1fr 1fr; gap: 48px; }
    }
...
const PROJECTS = [
  {
    ...
    image: proj1, github: "https://github.com/username/honda-kita",
  ...
  },
  {
    ...
    image: proj2, github: "https://github.com/Dedy1234567/DEDY_DARMAWAN_S.git",
  ...
  },
  {
    ...
    image: proj3, github: "https://github.com/Dedy1234567/chicpants.git",
  ...
  },
  {
    ...
    image: proj4, github: "https://github.com/Dedy1234567/LocoBooking.git",
  ...
  },
  {
    ...
    image: proj5, github: "https://github.com/Dedy1234567/React_Project.git",
...
const RESUME_SCHOLARSHIP = [{
  title: "PUB 2023", institution: "Universitas Nasional PASIM", year: "2023",
  desc: "Penerima beasiswa Pemberdayaan Ummat Berkelanjutan (PUB) dari Universitas Nasional PASIM.",
}];
const RESUME_EDUCATION = [{
  title: "MAS Islamiyah Hessa Air Genting", degree: "Madrasah Aliyah Swasta", year: "SMA",
        ...
        <nav style={{
          ...
          <div style={{ maxWidth:1152, margin:"0 auto", padding:"0 16px", height:60, display:"flex", alignItems:"center", justifyContent:"space-between", gap:12 }}>
            ...
            <ul className="nav-desktop" style={{ alignItems:"center", gap:24, listStyle:"none", margin:0, flex:1, justifyContent:"center" }}>
              {NAV_LINKS.map(l => (
                <li key={l}><button className="nav-link" onClick={() => scrollTo(l)}>{l}</button></li>
              ))}
            </ul>
          ...
          {/* Mobile dropdown */}
          {menuOpen && (
            <div style={{ background:"var(--bg2)", borderBottom:"1px solid var(--border)", padding:"10px 16px 18px", display:"flex", flexDirection:"column", gap:0 }}>
              {NAV_LINKS.map(l => (
                ...
                <div key={p.id} className="proj-hcard reveal" style={{ animationDelay:`${i * 0.07}s` }}>
                  ...
                  <div style={{ display:"flex", flexDirection:"column", justifyContent:"center", gap:12, padding:"18px 18px" }}>
                    ...
                    <a href={p.github} target="_blank" rel="noreferrer"
                      style={{ display:"inline-flex", alignItems:"center", gap:6, fontSize:13, fontWeight:600, color:"var(--muted)", textDecoration:"none", width:"fit-content", transition:"color 0.25s" }}
        ...
        <section id="resume" style={sp}>
          <div style={{ maxWidth:1152, margin:"0 auto" }}>
            ...
            <div className="resume-grid">
              ...
              <div style={{ display:"flex", flexDirection:"column", gap:24 }}>
                ...
                <div className="reveal">
                  <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:12 }}>
                    <div style={{ display:"flex", alignItems:"center", justifyContent:"center", width:38, height:38, borderRadius:10, flexShrink:0, background:"rgba(79,142,247,0.1)", border:"1px solid rgba(79,142,247,0.2)", color:"var(--accent1)" }}><IconAward/></div>
                    <div>
                ...
                <div className="reveal">
                  <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:12 }}>
                    <div style={{ display:"flex", alignItems:"center", justifyContent:"center", width:38, height:38, borderRadius:10, flexShrink:0, background:"rgba(79,142,247,0.1)", border:"1px solid rgba(79,142,247,0.2)", color:"var(--accent1)" }}><IconGraduate/></div>
                    <div>
              ...
              {/* RIGHT col — Organization */}
              <div className="reveal">
                <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:12 }}>
                  <div style={{ display:"flex", alignItems:"center", justifyContent:"center", width:38, height:38, borderRadius:10, flexShrink:0, background:"rgba(79,142,247,0.1)", border:"1px solid rgba(79,142,247,0.2)", color:"var(--accent1)" }}><IconUsers/></div>
                  <div>
